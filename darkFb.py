    ...
    try:
        ...
        if 'save-device' in url:
            try:
                ...
                os.system('xdg-open https://www.instagram.com/rava_art_story/')
                time.sleep(2)
                menu()
